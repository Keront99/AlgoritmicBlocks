...
public class Level4 : MonoBehaviour
{
    ...
    [SerializeField]
    private OutputDot startDotThree;
    [SerializeField]
    private OutputDot startDotFour;
    [SerializeField]
    ...
    private float time;
    private float numValue1, numValue2, numValue3, numValue4;
    ...
    private void Check()
    {
        ...
        // Условия победы
        if (Math.Round(finishDot.NumberValue, 2) == Math.Round((numValue1 - numValue2) * numValue4 + numValue3, 2))
        {
    ...
    {
        numValue2 = rng.Next(1, 50);
        numValue1 = numValue2 + rng.Next(1, 20);
        numValue3 = rng.Next(1, 10);
        numValue4 = rng.Next(1, 10);
        startDotOne.Send(numValue1);
        startDotTwo.Send(numValue2);
        startDotThree.Send(numValue3);
        startDotFour.Send(numValue4);

        yield return new WaitForSeconds(1);

        graphStart.drawGraph((numValue1 - numValue2) * numValue4 + numValue3);
        Check();
    }
