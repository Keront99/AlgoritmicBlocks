...
public class Level2_1 : MonoBehaviour
{
    ...
    private void Check()
    {
        ...
        if (numValue1 > 10)
        {
            ...
            graphFinish.drawGraph(2F);
            correctCount = numValue1 == finishDotOne.NumberValue ? correctCount += 1 : correctCount;
        }
        if (numValue1 <= 10)
        {
            //Debug.Log("+1 к победе");
            graphFinish.drawGraph(1F);
            correctCount += 1;
            correctCount = numValue1 == finishDotTwo.NumberValue ? correctCount += 1 : correctCount;
        }
    ...
    private IEnumerator CoroutineCheck()
    {
        ...
        graphStart.drawGraph(numValue1 > 10 ? 2 : 1);
        Check();
    }
