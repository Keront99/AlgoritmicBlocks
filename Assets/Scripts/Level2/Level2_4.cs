...
public class Level2_4 : MonoBehaviour
{
    [SerializeField]
    ...
    private void Check()
    {
        ...
        // Условия победы
        if (finishDotOne.NumberValue == numValue1 * numValue2)
        {
    ...
    {
        numValue1 = rng.Next(1, 60);
        numValue2 = rng.Next(1, 5);
        ...
        graphStart.drawGraph(numValue1 * numValue2);
        Check();
    }
